...
class WorkspaceScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WorkspaceScreen> createState() =>
      _WorkspaceScreenState();
}

class _WorkspaceScreenState
    extends ConsumerState<WorkspaceScreen> {
  Project? project;
  FileItem? active;
  ...
  Future<void> chooseProject(Project p) async {
    setState(() {
      project = p;
      active = null;
      editor.clear();
  ...
  void selectFile(FileItem f) {
    setState(() {
      active = f;
      editor.text = f.content;
      dirty = false;
    });
  }
  ...
  Future<void> newFile() async {
    ...
    final d = ValueNotifier<bool>(false);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: project == null ? null : newFile,
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Editor, chat y terminal viven en este workspace.',
                          style: TextStyle(
                            color: AppColors.muted,
                          ),
                        ),
